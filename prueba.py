	...
	# Se colocan los puntajes
		#font = pygame.font.SysFont(sysfont, 25)
		#puntaje1 = font.render('Tu Puntaje:', True, azul)
		#rect1 = puntaje1.get_rect()
		#pygame.draw.rect(puntaje1, rojo, rect1, 1)
		#puntaje2 = font.render('La Máquina:', True, azul)
		#pantalla.blit(puntaje1, (20, 460))
		#pantalla.blit(puntaje2, (20, 480))
